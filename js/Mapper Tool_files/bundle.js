...
var Geocoder = React.createClass({
  ...
  onKeyDown: function onKeyDown(e) {
    switch (e.which) {
      ...
      case 13:
        ...
        window.loc = this.state.results;
        var geocoder = L.mapbox.geocoder('mapbox.places');
        var lat = loc[0].geometry.coordinates[0];
        var lng = loc[0].geometry.coordinates[1];
        var that = this;
        function showMap(err, data) {
          mapLeaflet.setView([data.latlng[0], data.latlng[1]], 8);
          prevMarker.setLatLng(L.latLng(data.latlng[0],data.latlng[1])).update();
          React.findDOMNode(that.refs.input).value = loc[0].place_name;
        }
        geocoder.query(loc[0].place_name, showMap);
        // this.val(place.place_name);
        this.setState({
          results: [],
          focus: null,
          loading: false
  ...
  clickOption: function clickOption(place, listLocation) {
    ...
    React.findDOMNode(this.refs.input).val(place.place_name);
    geocoder.query(place.place_name, showMap);
    return false;
  },
  render: function render() {
    var _this = this;
...
},{"./search":166,"react":157}],3:[function(require,module,exports){
/**
...
},{"global/window":160,"once":161,"parse-headers":165}],160:[function(require,module,exports){
(function (global){
...
},{"is-function":163}],163:[function(require,module,exports){
...
},{"for-each":162,"trim":164}],166:[function(require,module,exports){
'use strict';
